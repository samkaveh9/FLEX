...
<html lang="en">
  <head>
    ...
    <!-- Template -->
    <link rel="stylesheet" href="{{ asset('panel/css/graindashboard.css') }}">
  </head>
  ...
  <body class="">
				...
				<div class="row justify-content-md-center">
					<div class="card-wrapper col-12 col-md-4 mt-5">
						<div class="brand text-center mb-3">
							<a href="/"><img src="{{ asset('panel/img/logo.png') }}"></a>
						</div>
						<div class="card">
							<div class="card-body">
	...
	<script src="{{ asset('panel/js/graindashboard.js') }}"></script>
    <script src="{{ asset('panel/js/graindashboard.vendor.js') }}"></script>
  </body>
</html>