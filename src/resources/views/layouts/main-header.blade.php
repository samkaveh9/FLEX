                            ...
                            <div class="t-header-search-result">
                                <a href="">
                                    ...
                                    <div class="t-header-search-result-left">
                                        <img src="/main/img/banner/laravel-payment-processing.jpg" alt="">
                                    </div>
                                </a>
                                <a href="">
                                    <div class="t-header-search-result-right">
            ...
            <div class="t-header-left">
                ...
                <div class="user-menu-account">
                    <div class="user-image">
                        <img src="/main/img/profile.jpg" alt="desction">
                    </div>
                        ...
                        <ul>
                            ...
                            <li>
                                <form action="{{ route('logout') }}" method="POST" id="logout">
                                    @csrf
                                    <button onclick="document.getElementById('logout').submit()">خروج</button>
                                </form>
                            </li>
                        </ul>
                    </div>
